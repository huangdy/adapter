...
public class XCoreUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(XCoreUtil.class);
    ...
    public static IncidentType getIncidentDocument(MappedRecord record) {
        ...
        incident.addNewActivityCategoryText().setStringValue(StringEscapeXCoreUtils.escapeXml(
            record.getCategory()));

        // set Acitivity Name
        // incident.addNewActivityName().setStringValue(StringEscapeXCoreUtils.escapeXml(record.getTitle()));
        ...
        // description.setStringValue(StringEscapeXCoreUtils.escapeXml(record.getDescription()));
        description.setStringValue(record.getDescription());

        // escape the content string
        // incident.addNewIncidentObservationText().setStringValue(StringEscapeXCoreUtils.escapeXml(record.getContent()));

        final StatusType status = incident.addNewActivityStatus();
        status.addNewStatusDescriptionText().setStringValue(StringEscapeXCoreUtils.escapeXml(
            record.getFilter()));
    ...
    // TODO: should be put in a common XCoreUtilities class
